...
// look (internally a 12.5× multiplier on biome stock); slider max 300%
// corresponds to a 37.5× internal multiplier, so the cap here matches.
const MAX_DENSITY_MULTIPLIER = 37.5;
